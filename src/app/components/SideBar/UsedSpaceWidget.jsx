...
function UsedSpaceWidget() {
  return (
     ...
     <div className="space-x-3">
       <button type="button" className="text-sm/5 font-medium text-violet-500 hover:text-violet-700">
         Dismiss
       </button>
       <button type="button" className="text-sm/5 font-semibold text-violet-700 hover:text-violet-900">
         Upgrade plan
       </button>
     </div>
   </div>
